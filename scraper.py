    ...
    if (screen_height) * i > scroll_height:
        ...
        try:
            driver.find_element_by_xpath(
                "/html/body/div/div[1]/div[2]/div/div[1]/div/div[3]/button"
            ).click()
        except (
            ElementClickInterceptedException,
            TimeoutException,
...
ticker = html_soup.find_all(
    "td",
    class_="cmc-table__cell cmc-table__cell--sortable cmc-table__cell--left cmc-table__cell--sort-by__symbol",
)
coin_name = html_soup.find_all(
    "div", class_="sc-1kxikfi-0 fjclfm cmc-table__column-name"
)
